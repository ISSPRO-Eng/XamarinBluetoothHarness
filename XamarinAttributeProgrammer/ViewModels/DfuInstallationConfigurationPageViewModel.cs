...
namespace XamarinAttributeProgrammer.ViewModels
{
    public class DfuInstallationConfigurationPageViewModel : BindableObject
    {
        ...
        /// Singleton instance
        /// </summary>
        public static DfuInstallationConfigurationPageViewModel Instance => _instance ??= new DfuInstallationConfigurationPageViewModel();

        public static DfuInstallationConfigurationPageViewModel _instance;
        #endregion
        ...
        private static void DfuInstallationOnStateChanged(object sender, DfuState e)
        {
            ...
            string dfuState = e.ToString();
            var dfu = new DFUPage();
            dfu.DfuState(dfuState);
        }
